...
export const questions: PlacementQuestion[] = [
  ...
  { id:'q05', level:'A1', category:'LISTENING', prompt:'Escucha el audio. ¿Dónde vive Ana?', options:['Madrid','Bogotá','São Paulo','Lima'], correctAnswer:'Madrid', mediaType:'AUDIO', mediaUrl:'/media/listening-a1.mp3', speechText:'Ana vive en Madrid.' },
  ...
  { id:'q10', level:'A2', category:'LISTENING', prompt:'Escucha el audio. ¿A qué hora empieza la clase?', options:['A las ocho','A las nueve','A las diez','A las once'], correctAnswer:'A las nueve', mediaType:'AUDIO', mediaUrl:'/media/listening-a2.mp3', speechText:'La clase de español empieza a las nueve.' },
  ...
  { id:'q15', level:'B1', category:'LISTENING', prompt:'Escucha el audio. ¿Por qué Carlos llegará tarde?', options:['Porque perdió el autobús','Porque está enfermo','Porque trabaja','Porque llueve'], correctAnswer:'Porque perdió el autobús', mediaType:'AUDIO', mediaUrl:'/media/listening-b1.mp3', speechText:'Carlos llegará tarde porque perdió el autobús.' },
  ...
  { id:'q20', level:'B2', category:'LISTENING', prompt:'Escucha el audio. ¿Qué propone Laura para resolver el problema?', options:['Cancelar el proyecto','Cambiar la fecha de entrega','Contratar a otra empresa','Reducir el presupuesto'], correctAnswer:'Cambiar la fecha de entrega', mediaType:'AUDIO', mediaUrl:'/media/listening-b2.mp3', speechText:'Laura propone cambiar la fecha de entrega para resolver el problema.' },
  ...
  { id:'q25', level:'C1', category:'LISTENING', prompt:'Escucha el audio. ¿Cuál es la principal preocupación del hablante?', options:['La falta de datos confiables','El costo del viaje','La duración de la reunión','La calidad del edificio'], correctAnswer:'La falta de datos confiables', mediaType:'AUDIO', mediaUrl:'/media/listening-c1.mp3', speechText:'Mi principal preocupación es que todavía no tenemos datos confiables para tomar una decisión.' },
  ...
  { id:'q30', level:'C2', category:'LISTENING', prompt:'Escucha el audio. ¿Qué matiz transmite el hablante sobre la propuesta?', options:['Entusiasmo absoluto','Aceptación con reservas','Rechazo categórico','Indiferencia total'], correctAnswer:'Aceptación con reservas', mediaType:'AUDIO', mediaUrl:'/media/listening-c2.mp3', speechText:'La propuesta me parece razonable y podría funcionar, aunque todavía tengo algunas reservas importantes.' },
];
